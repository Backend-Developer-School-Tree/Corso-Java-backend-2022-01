...
public class CivilRegistry {
    private static Set<Person> registry = new HashSet<>();
    ...
    public static void main(String[] args) {
        Person p0 = new Person("chiara", "rossi", "0",
                "Via Torino", LocalDate.of(1997, 12, 22), new HashSet<>());
        Person p3 = new Person("marta", "rossi", "3",
                "Via Torino", LocalDate.of(1985, 12, 22), new HashSet<>());
        Person p4 = new Person("piero", "rossi", "4",
                "Via Ragusa", LocalDate.of(1995, 12, 22), new HashSet<>());
        Person p1 = new Person("cristina", "rossi", "1",
                "Via Roma", LocalDate.of(1945, 12, 22), new HashSet<>());
        Person p2 = new Person("mario", "rossi", "2",
                "Via Milano", LocalDate.of(1935, 12, 22), Stream.of(p3).collect(Collectors.toSet()));
        Person p5 = new Person("mario alberto", "rossi", "5",
                "Via Palermo", LocalDate.of(1946, 12, 22), Stream.of(p4, p0).collect(Collectors.toSet()));
